...
class ChatClient(Frame):
  ...
  def initUI(self):
    ...
    self.receivedChats = Text(readChatGroup, bg="#000000",foreground="#24ff14", width=60, height=30, state=DISABLED)
    self.friends = Listbox(readChatGroup, bg="#000000",foreground="#24ff14", width=30, height=30)
